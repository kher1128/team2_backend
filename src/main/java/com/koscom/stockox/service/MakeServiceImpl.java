...
public class MakeServiceImpl implements  MakeService{
    ...
    public void makeProblemAboutKospi() {
        ...
        String answer = "kospi 가격은 " +priceBogi.getAnswer() +"이다.";
        String wrongAnswer1 = "kospi 가격은 " + priceBogi.getWrongAnswer1() +"이다.";
        String wrongAnswer2 = "kospi 가격은 " + priceBogi.getWrongAnswer2() +"이다.";
        String wrongAnswer3 = "kospi 가격은 " + priceBogi.getWrongAnswer3() +"이다.";
        String flag = "3";
    ...
    public void makeProblemAboutKosdaq() {
        ...
        String answer = "kosdaq 가격은 " +priceBogi.getAnswer() +"이다.";
        String wrongAnswer1 = "kosdaq 가격은 " + priceBogi.getWrongAnswer1() +"이다.";
        String wrongAnswer2 = "kosdaq 가격은 " + priceBogi.getWrongAnswer2() +"이다.";
        String wrongAnswer3 = "kosdaq 가격은 " + priceBogi.getWrongAnswer3() +"이다.";
        String flag = "4";
